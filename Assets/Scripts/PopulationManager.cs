...
public class PopulationManager : MonoBehaviour {
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 25,200, 140), "Gen "+generation, guiStyle);
        GUI.Label(new Rect(10, 50, 200, 140), string.Format("Time: {0:0.00}",elapsed), guiStyle);
        GUI.Label(new Rect(10, 75, 200, 140), "Status "+populationSize, guiStyle);
        GUI.EndGroup();
    }
    private void Start()
    {
